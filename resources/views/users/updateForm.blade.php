<x-app-layout>
    ...
    <div>
        ...
        <x-text-input id="suffex_name" class="block mt-1 w-full" type="text" name="suffex_name" :value="old('suffex_name', $user->suffex_name ?? '')"  />
    </div>
    ...
    <div class="mt-4">
        ...
        <x-text-input id="type" class="block mt-1 w-full" type="text" name="type" :value="old('type', $user->type ?? '')" />
    </div>
